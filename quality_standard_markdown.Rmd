...
# First
## Select quality standard and read from URL
```{r select}
qs_number <- 33
...
print(sprintf("QS%s: %s", qs_number, qs_name))
```

## Extract links to quality statements within QS

```{r quality-statements}
...
# Extract quality statement (loop later)
...
## Separate out and label points within each measure
### Create function
```{r separate}
